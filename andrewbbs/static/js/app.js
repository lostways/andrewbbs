...
/***/ "./resources/js/vendor/386/bootstrap.js":
/*!**********************************************!*\
  !*** ./resources/js/vendor/386/bootstrap.js ***!
  \**********************************************/
/*! no static exports found */
...
$(function () {
  ...
  function scrollLock() {
    ...
    $(window).bind('scroll', function (e) {
      ...
      console.log(off, last, off < last ? "up" : "down"); // this determines whether the user is intending to go up or down.

      func = off < last ? "floor" : "ceil"; // make sure we don't run this from ourselves
  ...
  function loading() {
    ...
    wrap = document.createElement('div'), bar = wrap.appendChild(document.createElement('div')), cursor = document.createElement('div'), // If the user specified that the visibility is hidden, then we
    // start at the first pass ... otherwise we just do the 
    // cursor fly-by
    pass = $(document.body).css('visibility') == 'visible' ? 1 : 0, height = $(window).height(), width = $(window).width(), // this makes the loading of the screen proportional to the real-estate of the window.
...
/***/ 0:
/*!**********************************************************************************************************!*\
  !*** multi ./resources/js/vendor/jquery.js ./resources/js/vendor/386/bootstrap.js ./resources/js/app.js ***!
  \**********************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! /c/Users/pcmah/Dropbox/code/laragon/www/andrewbbs/resources/js/vendor/jquery.js */"./resources/js/vendor/jquery.js");
__webpack_require__(/*! /c/Users/pcmah/Dropbox/code/laragon/www/andrewbbs/resources/js/vendor/386/bootstrap.js */"./resources/js/vendor/386/bootstrap.js");
module.exports = __webpack_require__(/*! /c/Users/pcmah/Dropbox/code/laragon/www/andrewbbs/resources/js/app.js */"./resources/js/app.js");
