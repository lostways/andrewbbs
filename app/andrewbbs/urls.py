...
urlpatterns = [
    ...
    path(
        "create/codes",
        views.access_code_list,
        name="access-code-list"
    ),
    path(
        "create/code/<int:pk>",
    ...
    path(
        "create/screens",
        views.screen_edit_list,
        name="screen-edit-list",
    ),
    path(
        "create/screen/<int:pk>",
        views.screen_edit_detail,
        name="screen-edit-detail",
    ),
    ...
    path(
        "members/messages/send", views.member_message_send, name="member-message-send"
    ),
    path(
        "members/messages/sent", views.member_message_sent, name="member-message-sent"
    ),
    path(
